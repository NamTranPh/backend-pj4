...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    // Cho phép override qua application.properties hoặc env vars (ví dụ: APP_ADMIN_PHONE, APP_ADMIN_PASSWORD)
    ...
    private void seedAdminUser() {
        ...
        if (!userRepository.existsByPhone(adminPhone)) {
            ...
            admin.setEmail(adminEmail);              // có thể để mặc định hoặc null tuỳ entity nullable
